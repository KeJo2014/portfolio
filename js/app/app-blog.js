var blog = {
    ...
    init: function () {
        ...
        var stages = [{ name: "Day of the Fight", date: "1951-04-26", img: "http://upload.wikimedia.org/wikipedia/en/thumb/c/c4/Day_of_the_Fight_title.jpg/215px-Day_of_the_Fight_title.jpg" },
        ...
        TimeKnots.draw("#timeline1", kurbickFilms, { dateFormat: "%B %Y", color: "#08fdd8", width: window.innerWidth, showLabels: true, labelFormat: "%Y" });
