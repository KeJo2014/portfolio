  ...
  draw: function (id, events, options) {
    ...
    if (cfg.showLabels != false) {
      ...
      svg.append("text")
        ...
        .text(startString).style("color", "white")
    ...
    svg.on("mousemove", function () {
      ...
      switch (currentNode.name) {
        case "birth":
          ...
          break;
        case "Grundschule":
          left = 0.5 * d3.event.pageX;
          break;
        case "Gymnasium Lohr":
          left = 0.65 * d3.event.pageX;
          break;
        case "CTO brewing technologies":
          left = 0.7 * d3.event.pageX;
          break;
        case "Praktikum SAP":
          left = 0.7 * d3.event.pageX +20;
          break;
        default:
          break;
      }
      return tip.style("top", "-5px").style("left", left+"px");
    })
...
function plotTimeline() {
  var points = [{ name: "birth", date: "2004-10-07", img: "media/Foto_rechts.png" },
  { name: "Grundschule", date: "2011-01-01", img: "media/gs-wiesthal.svg" },
  { name: "Gymnasium Lohr", date: "2016-01-01", img: "media/gy-lohr.jpg" },
  { name: "Praktikum SAP", date: "2021-07-10", img: "media/sap-trans.png" },
  { name: "CTO brewing technologies", date: "2021-09-01", img: "media/brew-sem.png" },
  ];

  TimeKnots.draw("#timeline1", points, {dateFormat: "%B %Y", color: "#08fdd8", width:(window.innerWidth*0.8), showLabels: true, labelFormat: "%Y"});
}